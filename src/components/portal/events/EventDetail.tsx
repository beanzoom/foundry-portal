...
export function EventDetail() {
  ...
  console.log('[EventDetail] Component mounted with id:', id);
  ...
  const loadEvent = async () => {
    ...
    console.log('[EventDetail] Loading event with id:', id);
    try {
      setLoading(true);
  ...
  // Share functionality removed - not relevant for portal
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8">
      {/* Hero Section */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-br from-violet-500/10 via-violet-500/5 to-white dark:to-gray-900 border">
              ...
              <div className="space-y-3">
                {event.dates && event.dates.length > 0 ? (
                  ...
                  <div className="p-8 text-center bg-muted/50 rounded-lg">
                    ...
                    <p className="text-sm text-muted-foreground mt-1">Event dates will be announced shortly</p>
                  </div>
                )}
              </div>
            </CardContent>
